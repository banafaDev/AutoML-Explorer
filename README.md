...
- **Advanced Optimization** - Optuna hyperparameter tuning for peak performance
...
- **Advanced Optimization**:
  ...
  - Configurable iteration count (10-500)
...
- **[Optuna](https://optuna.org/)** `3.x` - Hyperparameter optimization
  - TPE sampler
...
- **Optuna Iterations**: 10-500 (default: 50)
...
- Optional Optuna tuning of best model
...
AutoML Explorer uses Optuna's TPE (Tree-structured Parzen Estimator) sampler for intelligent hyperparameter search:

- **Adaptive Sampling**: Learns from previous trials
- **Pruning**: Stops unpromising trials early
- **Multi-objective**: Optimizes for primary metric while considering training time
- **Search Space**: Automatically generated by PyCaret based on model type
...
- [Optuna](https://optuna.org/) - Powerful hyperparameter optimization
